...
flowchart LR
    ...
    class SRC_STUDENTS_SCORE SRC_SUBJECTS SRC_COUNTRIES SRC_EMPLOYEE_INDIA SRC_STUDENTS SRC_EMPLOYEES SRC_EMPLOYEE_DUB src;
    class TGT_EMPLOYEE_SEQUENCE_NUMBER TGT_DEPT_SALARY TGT_STUDENTS_DETAILSHEET TGT_ORG_EMPLOYEE_DEFAULT TGT_COUNTRY_DATA TGT_students_rec TGT_EMPLOYEE_RANK TGT_ORG_EMPLOYEE_DEPT3 TGT_ORG_EMPLOYEE_DEPT2 TGT_EMPLOYEE_ALL TGT_ORG_EMPLOYEE_DATA TGT_EMPLOYEE_DEPT TGT_ORG_EMPLOYEE_DEPT1 tgt;
